...
const HomePage: Component = () => {
  ...
  return (
    <main class="text-gray-600 body-font">
      <section class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center duration-300">
        <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center duration-300">
          ...
          <p class="mb-8 leading-relaxed font-mono font-extrabold">
            {vm.clock.time()} seconds since first render
          </p>
