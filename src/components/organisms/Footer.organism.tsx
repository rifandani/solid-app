...
const Footer: Component = () => {
  return (
    <footer class="bg-white">
      <div class="px-4 pt-16 pb-6 mx-auto sm:px-6 lg:px-8 lg:pt-24">
                  ...
                  <li>
                    ...
                    >
                      ...
                      <span class="relative flex w-2 h-2 -mr-2">
                        <span class="absolute inline-flex w-full h-full bg-violet-400 rounded-full opacity-75 animate-ping"></span>
                        <span class="relative inline-flex w-2 h-2 bg-violet-500 rounded-full"></span>
                      </span>
                    </a>
                  </li>
                </ul>
        ...
        <div class="pt-6 mt-12 border-t border-gray-100">
          <div class="text-center sm:flex sm:justify-between sm:text-left duration-300">
